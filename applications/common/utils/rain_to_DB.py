...
# 读取 .xlsx 文件
file_path = 'D:\\postgraduate\\project\\MyPatternLibrary\\FloodFeature\\data\\屯溪数据\\1989\\雨量数据\\左龙.xls'    # 替换为你的文件路径
...
# 添加 station_id 列并设置为 70134000
df['station_id'] = '70134200'

# 重命名列以匹配数据库字段名
df = df.rename(columns={'time': 'time', 'rain': 'rain_value'})

# 调整列的顺序
df = df[['station_id', 'time', 'rain_value']]
